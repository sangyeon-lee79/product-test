...
### 0.10 식단 L3 Seed 확장 정책 (2026-03-08)
- 목표:
  - L1 식단유형 하위의 L2 식단하위유형 전체가 L3 사료종류와 연결되도록 구조 보장
- 정책:
  - L3가 없는 L2는 자동 보강 seed로 최소 1개 L3 항목 생성
...
### 0.12 국가/통화 기본 데이터 보강 (2026-03-08)
- 관리자 국가/통화 관리 기본값 확장:
  - 국가: 한국(KR), 미국(US), 베트남(VN), 일본(JP)
  - 통화: KRW, USD, VND, JPY
- 요구 규칙:
...
### 0.14 장치/사료 카탈로그 등록 규칙 강화 (2026-03-08)
- 대상:
  - 장치관리자, 사료관리자
- 구조:
  - 유형 → 제조사 → 브랜드 → 모델/제품
