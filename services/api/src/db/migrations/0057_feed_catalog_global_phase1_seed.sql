...
WITH l3(id, parent_l2_code, item_code, sort_order) AS (
  VALUES
    ...
    ('mi-diet-feed-raw-frozen-food-core', 'raw_frozen_food', 'raw_frozen_food_core', 9008),
...
WITH t(key, ko, en) AS (
  VALUES
    ...
    ('master.diet_feed_type.raw_frozen_food_core', '냉동 생식 기본형', 'Frozen Raw Food Core'),
...
WITH seed_model(
  ...
  VALUES
    ...
    ('ray_yvonne_deer_eggshell_raw_9p', 'raw_frozen_food_core', 'ray_n_yvonne', 'ray_yvonne_raw_line', 'feed.model.ray_yvonne_deer_eggshell_raw_9p', '레이앤이본 사슴고기 난각 생식 9P', '', '{"package_weight_value":9,"package_weight_unit":"pack","life_stage_key":"adult","species_key":"dog"}', 21),
    ('ray_yvonne_lamb_bone_raw_12p', 'raw_frozen_food_core', 'ray_n_yvonne', 'ray_yvonne_raw_line', 'feed.model.ray_yvonne_lamb_bone_raw_12p', '레이앤이본 뼈있는 양고기 생식 12P', '', '{"package_weight_value":12,"package_weight_unit":"pack","life_stage_key":"adult","species_key":"dog"}', 22),
