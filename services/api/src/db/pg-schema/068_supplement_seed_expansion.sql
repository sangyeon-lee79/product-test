...
VALUES
  ...
  ('b7fb70cc066d57ebb3112fdad877840a', 'royal_canin',        'supplement.manufacturer.royal_canin',        '로얄캐닌',         'Royal Canin',           'FR', 'active', 114, 'supplement', NOW(), NOW()),
...
VALUES
  ...
  ('c0e5f6a7b8c9d0e1f2a3b4c5d6e7f8a9', 'b7fb70cc066d57ebb3112fdad877840a', 'supplement.brand.royal_canin', '로얄캐닌',    'Royal Canin',  'active', 'supplement', NOW(), NOW()),
...
VALUES
  ...
  ('d1a1b2c3d4e5f6a7b8c9d0e1f2a3b4c5', 'mi-suppl-joint',        'b7fb70cc066d57ebb3112fdad877840a', 'c0e5f6a7b8c9d0e1f2a3b4c5d6e7f8a9', 'supplement.model.mobility_c2p',          'Mobility C2P+',             'RC-MOB',     '{"ingredients":"Glucosamine+Chondroitin+EPA+DHA","dosage_unit":"tablet","species_key":"dog","prescribed":false}', 'active', 'supplement', NOW(), NOW()),
...
VALUES
  ...
  (md5('suppl_mfr_type_royal_canin_joint'),     'b7fb70cc066d57ebb3112fdad877840a', 'mi-suppl-joint',        NOW()),
...
VALUES
  ...
  (md5('suppl_brand_mfr_royal_canin'),   'c0e5f6a7b8c9d0e1f2a3b4c5d6e7f8a9', 'b7fb70cc066d57ebb3112fdad877840a', NOW()),
