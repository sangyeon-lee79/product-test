/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 3b84a1f443683922e93f6594cfa4b2be)
...
declare namespace Cloudflare {
	...
	interface StagingEnv {
		ENVIRONMENT: "staging";
		ALLOWED_ORIGINS: "https://admin-staging.petlife.com,https://guardian-staging.petlife.com";
		JWT_SECRET: "staging-secret";
	}
	interface ProductionEnv {
		ENVIRONMENT: "production";
		ALLOWED_ORIGINS: "https://admin.petlife.com,https://guardian.petlife.com";
		JWT_SECRET: "REPLACE_WITH_SECURE_SECRET";
	}
	interface Env {
		ENVIRONMENT: "staging" | "production";
		ALLOWED_ORIGINS: "https://admin-staging.petlife.com,https://guardian-staging.petlife.com" | "https://admin.petlife.com,https://guardian.petlife.com" | "http://localhost:5173,http://localhost:5174,https://pet-life-admin.pages.dev,*.pet-life-admin.pages.dev,https://product-webtest.pages.dev,*.product-webtest.pages.dev,*.cluster.cloudworkstations.dev";
		JWT_SECRET: "staging-secret" | "REPLACE_WITH_SECURE_SECRET" | "dev-secret-change-in-production";
		DB?: D1Database;
		R2_PUBLIC_URL?: "";
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "ALLOWED_ORIGINS" | "JWT_SECRET" | "R2_PUBLIC_URL">> {}
}
